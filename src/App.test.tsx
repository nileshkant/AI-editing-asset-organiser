...
describe('desktop foundation', () => {
  ...
  it('starts with AI disabled', () => { render(<App/>); fireEvent.click(screen.getByRole('button',{name:'Settings'})); expect(screen.getByText(/AI features/)).toBeInTheDocument(); expect(screen.getByText(/Disabled/)).toBeInTheDocument(); });
});
