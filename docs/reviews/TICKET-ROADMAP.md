...
- SS-001, SS-002, SS-003, SS-007, and SS-027 are complete in main history.
...
- SS-028 is implemented and pushed, but remains in review until its PR and
  Windows CI complete.
...
The queue first closes the Windows build and existing partial foundations.
