...
1. [SS-009: Library workspace and accessibility](SS-009.md) | partial | finish against real playback and large libraries
2. [SS-011: Waveform visualization](SS-011.md) | not-started | add playback-synced multiresolution waveform
